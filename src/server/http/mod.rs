...
pub async fn sse_client(app_state: web::Data<AppState>) -> RustackiHttpResponse{
...
macro_rules! bootsteap_http {
    (
        ...
        {   
            ...
            use actors::consumers::notif::*;
            use actors::producers::notif::*;
            use actors::cqrs::mutators::event::*;
            use actors::cqrs::accessors::event::*;
                ...
                App::new()
                    ...
                    */
                    ...
                    /*
                        SSE ROUTES
                    */
                    .route("/subsribe/events{_:/?}", web::get().to(sse_client)) // eg: /events, /events/123, /events/abc -> fetching event
                    .route("/subsribe/events/{msg}", web::get().to(broadcast_event))
                }) 
